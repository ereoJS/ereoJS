...
async function generateTailwindProject(
  ...
  const packageJson = {
    ...
    dependencies: {
      ...
      '@areo/data': '^0.1.0',
      '@areo/cli': '^0.1.0',
      '@areo/runtime-bun': '^0.1.0',
      '@areo/plugin-tailwind': '^0.1.0',
      react: '^18.2.0',
      'react-dom': '^18.2.0',
    },
    devDependencies: {
      '@areo/testing': '^0.1.0',
      '@areo/dev-inspector': '^0.1.0',
      ...(ts
        ? {
            '@types/react': '^18.2.0',
            '@types/react-dom': '^18.2.0',
  ...
  // ============================================================================
  const areoConfig = `
import { defineConfig, env } from '@areo/core';
...
`.trim();
  ...
  await Bun.write(join(projectDir, `areo.config.${ts ? 'ts' : 'js'}`), areoConfig);
...
export const posts${ts ? ': Post[]' : ''} = [
  {
    ...
    excerpt: 'Learn how to build modern web applications with Areo, the React fullstack framework powered by Bun.',
    content: \`
# Getting Started with Areo

Areo is a modern React fullstack framework that runs on Bun, offering exceptional performance and developer experience.
...
You're now ready to build amazing applications!
    ...
    date: '2024-01-15',
    readTime: '5 min read',
    tags: ['areo', 'react', 'tutorial'],
  },
  {
    slug: 'understanding-loaders-and-actions',
    title: 'Understanding Loaders and Actions',
    excerpt: 'Deep dive into Areo\\'s data loading and mutation patterns for building robust applications.',
    content: \`
# Understanding Loaders and Actions

Loaders and actions are the core data primitives in Areo.
...
\\\`\\\`\\\`
    ...
    date: '2024-01-20',
    readTime: '8 min read',
    tags: ['areo', 'data', 'tutorial'],
  },
  {
    slug: 'styling-with-tailwind',
    title: 'Styling with Tailwind CSS',
    excerpt: 'How to use Tailwind CSS effectively in your Areo applications for beautiful, responsive designs.',
    content: \`
# Styling with Tailwind CSS

Areo comes with first-class Tailwind CSS support out of the box.
      ...
      <div className="max-w-6xl mx-auto px-4">
        <div className="flex items-center justify-between h-16">
          ...
          <a href="/" className="flex items-center space-x-2">
            ...
            <span className="font-bold text-xl">Areo</span>
          </a>
 ...
 * This demonstrates client-side interactivity with Areo's islands architecture.
      ...
      <div className="max-w-6xl mx-auto px-4 py-8">
        <div className="flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="flex items-center space-x-2 text-gray-600 dark:text-gray-400">
            ...
            <span>Built with Areo</span>
          </div>
          <div className="flex items-center gap-6 text-sm text-gray-500 dark:text-gray-500">
            <a href="https://github.com/areo-js/areo" target="_blank" rel="noopener" className="hover:text-primary-600">
              GitHub
            </a>
            <a href="https://areo.dev/docs" target="_blank" rel="noopener" className="hover:text-primary-600">
              Documentation
            </a>
  ...
  return (
    <html lang="en">
      <head>
        <meta charSet="utf-8" />
        <meta name="viewport" content="width=device-width, initial-scale=1" />
        <meta name="description" content="A modern web application built with Areo" />
        <title>${projectName}</title>
    ...
    <div className="min-h-screen">
      ...
      <section className="py-16 px-4">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl font-bold text-center mb-12">Why Areo?</h2>
    ...
    <div className="min-h-screen">
      ...
      <div className="bg-gradient-to-r from-primary-600 to-purple-600 text-white py-12 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-primary-100">Tutorials, guides, and updates from the Areo team</p>
        </div>
      </div>
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="prose dark:prose-invert prose-lg max-w-none">
          <p className="text-xl text-gray-600 dark:text-gray-400 mb-8">
            This project was created with Areo, a modern React fullstack framework built on Bun.
          </p>
...
└── styles.css\`}
          ...
          <div className="card">
            ...
            <p className="text-gray-600 dark:text-gray-400 mb-4">
              Check out the documentation and resources to learn how to build with Areo:
            </p>
            <div className="flex flex-wrap gap-4">
              <a
                href="https://areo.dev/docs"
                target="_blank"
                rel="noopener"
...
A modern web application built with [Areo](https://github.com/areo-js/areo) - a React fullstack framework powered by Bun.
