/**
 * @areo/bundler - Route Type Generation
 *
...
import type { Route, RouteModule } from '@areo/core';
...
export function generateRouteTypes(
  ...
  const lines: string[] = [
    '// Auto-generated by @areo/bundler',
  ...
  lines.push("declare module '@areo/core' {");
...
export type ParamsFor<T extends RoutePath> =
  T extends keyof import('@areo/core').RouteTypes
    ? import('@areo/core').RouteTypes[T]['params']
...
export type LoaderDataFor<T extends RoutePath> =
  T extends keyof import('@areo/core').RouteTypes
    ? import('@areo/core').RouteTypes[T]['loader']
    : unknown;
...
export type ActionDataFor<T extends RoutePath> =
  T extends keyof import('@areo/core').RouteTypes
    ? import('@areo/core').RouteTypes[T]['action']
    : unknown;
...
export function createTypesPlugin(options: {
  ...
  const { outDir = '.areo', routesDir = 'app/routes', inferTypes = true, watch = false } = options;
  let routes: Route[] = [];
