...
EreoJS already handles API routes via [HTTP method exports](/concepts/data-loading#api-routes-http-method-exports) in your route files. You only need Vercel-native serverless functions if you want to run code outside the EreoJS router:
...
- [Deploying to Cloudflare](/ecosystem/deployment/cloudflare) — Alternative deployment platform
