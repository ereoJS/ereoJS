...
> **Note on approach:** This tutorial continues using `createLoader` and `createAction` with the shorthand form. For routes needing caching or validation, you can switch to the options object form. See [Data Loading](/concepts/data-loading) for details.
...
[← Previous: Data Loading](/tutorials/blog/03-data-loading) | [Continue to Chapter 5: Styling →](/tutorials/blog/05-styling)
